...
= 2.0.8 =
* Fixed: Fixed issue with function manage_post_columns()

= 2.0.7 =
* Fixed: Language strings on " Icon" Label

= 2.0.6 =
* Compatibility for WP 5.4.x
* Fixed: ensure filter is only for back-end - https://wordpress.org/support/topic/fix-needed-for-use-w-wp-5-4/
* Fixed: conflict with other settings api classes, renamed
* Fixed: bug with other icon classes, fixed dashicons picker
